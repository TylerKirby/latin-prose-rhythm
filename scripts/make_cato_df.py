...
cato_texts_path = '/Users/tyler/Datasets/phi-macronized/cato/'
analyze = Analyze()
...
rhythm_data.to_csv('../data/cato_rhythms.csv', index=None)
rhythm_data = pd.read_csv('../data/cato_rhythms.csv')
...
df.to_csv('../data/cato_df.csv', index=None)
